...
Barell::Barell(float x, float y, float z, color_t color) {
...
////
    ...
    this->object1 = create3DObject(GL_TRIANGLES, 360*18, vertex_buffer_data1, COLOR_MAGENTA, GL_FILL);
...
void Barell::set_position(float x, float y, float z) {
    this->position = glm::vec3(x, y, z);
}
